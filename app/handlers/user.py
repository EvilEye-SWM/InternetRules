...
rule_dict = {
    ...
    '18': 'Копипаста сделана для того чтобы уничтожить последнее проявление оригинальности.',
    ...
    '22': '/b/ сегодня фейлит.',
    '23': 'Копипаста сделана для того чтобы уничтожить последнее проявление оригинальности.',
    ...
    '37': 'Копипаста сделана для того чтобы уничтожить последнее проявление оригинальности.',
